                    ...
                    <table className="w-full border-collapse text-left text-sm text-zinc-400">
                        ...
                        <tbody className="divide-y divide-zinc-800/60 bg-[#1e1e1e]">
                            {users.map((user) => {
                                ...
                                const userRole = user.role?.toLowerCase() || 'lesson-student';
                                    ...
                                    <tr key={userId} className="hover:bg-zinc-900/40 transition-colors duration-150">
                                        ...
                                        <td className="py-4 px-6 text-right whitespace-nowrap text-xs font-medium">
                                            <div className="flex items-center justify-end gap-4">
                                                ...
                                                {userRole !== 'lesson-creator' && (
                                                    <button
                                                        onClick={() => initiateRoleChange(userId, user.name, 'lesson-creator')}
                                                        className="text-zinc-400 hover:text-white transition-colors"
                                                    >
                                                        Make Lesson Creator
                                                    </button>
                                                )}
                                                {userRole !== 'lesson-student' && (
                                                    <button
                                                        onClick={() => initiateRoleChange(userId, user.name, 'lesson-student')}
                                                        className="text-zinc-400 hover:text-white transition-colors"
                                                    >
                                                        Make Lesson Student
                                                    </button>
